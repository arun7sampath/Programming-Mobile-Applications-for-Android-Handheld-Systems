...
public class DownloaderTaskFragment extends Fragment {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		ArrayList<Integer> alInt = getArguments().getIntegerArrayList(MainActivity.TAG_FRIEND_RES_IDS);
		Integer[] resIDs = new Integer[alInt.size()];
		resIDs = alInt.toArray(resIDs);
			...
			mContext.sendOrderedBroadcast(new Intent(
					...
					new BroadcastReceiver() {
						...
						public void onReceive(Context context, Intent intent) {
							...
							boolean isMainActivity = getResultCode() != MainActivity.IS_ALIVE;
							if (isMainActivity) {
